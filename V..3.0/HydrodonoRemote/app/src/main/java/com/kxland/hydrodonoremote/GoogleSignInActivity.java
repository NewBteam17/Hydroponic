...
public class GoogleSignInActivity extends BaseActivity implements
    ...
    private Button button_monitoring;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_monitoring = (Button) findViewById(R.id.monitoring_button);
        ...
        button_monitoring.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GoogleSignInActivity.this, MonitoringIDActivity.class);
