...
<head>
    ...
    <link rel="stylesheet" href="assets/css/nivo-lightbox/nivo-lightbox.css">
    <link rel="stylesheet" href="assets/css/nivo-lightbox/nivo-lightbox-theme.css">
    ...
    <section id="header" class="header">
                ...
                <div class="navigation" id="navigation-scroll">
                        <div class="row">
                            <div class="col-md-11 col-xs-10">
                                <a href="index.html"><span id="logo"><strong class="strong">N</strong>ewB</span></a>
                            </div>
        ...
        <div class="container">
            <div class="starting">
                <div class="row">
                    <div class="col-md-6">
                        <img src="assets/img/LUCY2.png" alt="LUCY" class="wow flipInY animated animated">
                    </div>
                    <div class="col-md-6">
                        <div class="banner-text">
                             <h2 class="animation-box wow bounceIn animated"><strong class="strong">NewB Team</strong><br>
                            Development</h2>
                            <p>
                                  Download this app on your Android. Reviews and ratings are much appreciated.

                            </p>
                            
                            <a href="https://play.google.com/store/apps/details?id=com.kxland.hydrodonoremote" class="btn btn-download wow animated fadeInLeft">
...
{{--
    ...
    <div id="team" class="wrapper">
        <div class="container-fluid">
            ...
            <div class="circle"></div>
            <div class="row">
                <div class="col-md-2 col-sm-4 col-md-offset-1 wow animated fadeInLeft">
                    <img src="assets/img/team1.png" alt="team">
                    <img src="assets/img/icon-p.png" alt="icon-p" class="icon-p">
                    <h3>1</h3>
                    <p>Dini Hamidin</p>
                    <div class="img-hover">
                ...
                <div class="col-md-2 col-sm-4 animation-box wow bounceIn animated">
                    ...
                    <div class="img-hover">
                        ...
                        <img src="assets/simg/icon-m.png" alt="icon-m" class="icon-m">
                    </div>
                </div>
                                <div class="col-md-2 col-sm-4 animation-box wow bounceIn animated">
                    <img src="assets/img/team2.png" alt="team">
                ...
                <div class="col-md-2 col-sm-4 wow animated fadeInRight">
                    ...
                    <div class="img-hover">
                        ...
                        <img src="assets/img/icon-m.png" alt="icon-m" class="icon-m">
                    </div>
                </div>
                <div class="col-md-2 col-sm-4 wow animated fadeInRight">
                    <img src="assets/img/team3.png" alt="team">
        ...
        <div  class="container">
            <div class="row">
                ...
                <div class="col-md-3 contact-item col-sm-6 col-xs-12 wow animated fadeInRight">
                    ...
                    <h3>Email Address</h3>
                    <p class="contact">
                        <a href="newbteam17@gmail.com">newbteam17@gmail.com</a> <br>
                    </p>
                </div>
            </div> <!-- /.row -->
    ...
    <section id="footer" class="wrapper">
        <div class="container text-center">
            <div class="footer-logo">
                <h1 class="text-center animation-box wow bounceIn animated">NewB Team</h1>
            </div>
    ...
    <div class="overlay overlay-hugeinc">
        ...
        <ul>
            ...
            <li class="hideit"><a href="#header">Feature</a></li>
            <li class="hideit"><a href="#header">Gallery</a></li>
            <li class="hideit"><a href="#team">Team</a></li>
            <li class="hideit"><a href="#header">Contact Us</a></li>
